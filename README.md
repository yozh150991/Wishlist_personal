...
**Редизайн інтерфейсу** (вересень 2026) — новий вигляд усіх екранів і **три кольорові схеми** × дві теми: Шавлія, Слива, Вугіль. Схема й тема незалежні, вибір власника зберігається в профілі; гість обирає вигляд сам. Контраст усіх шести палітр перевіряється в CI — `npm run check:contrast`, 150 перевірок. Усі екрани перероблено, e2e проти локальної бази зелений у двох розкладках; лишилась ручна перевірка — Lighthouse, клавіатура, три мови очима. Деталі — ADR-031 і [docs/ROADMAP.md](./docs/ROADMAP.md).
